defmodule CarRentals.CategoriesTest do
  use CarRentals.DataCase

  alias CarRentals.Categories

  describe "categories" do
    alias CarRentals.Categories.Category

    import CarRentals.CategoriesFixtures
